...
<div class="min-vh-100 d-flex">
  ...
  <div class="auth-hero d-none d-lg-flex flex-column justify-content-between p-5" style="width:42%;">
    <div class="brand fs-3 text-white">Pharma<span style="-webkit-text-fill-color:#fff">Track</span></div>
    <div>
  ...
  <div class="flex-fill d-flex align-items-center justify-content-center p-3 p-md-5">
    <div style="max-width:420px;width:100%">
      <div class="d-lg-none brand fs-3 text-center mb-4">Pharma<span>Track</span></div>
      @yield('form')
    </div>
  </div>
</div>
